...
public class Solution {
    ...
    public static class Ferrari extends LuxuriousCar {
        public void printlnDesire() {
            System.out.println(c.WANT_STRING + c.FERRARY_NAME);
        }
    }

    public static class Lanos extends CheapCar {
        public void printlnDesire() {
            System.out.println(c.WANT_STRING + c.LANOS_NAME);
        }
    }
    ...
    public static class LuxuriousCar /*extends Constants*/ {
        Constants c = new Constants();
         void printlnDesire() {
            System.out.println(c.WANT_STRING + c.LUXURIOUS_CAR);
        }
    }
    ...
    public static class CheapCar /*extends Constants*/{
        ...
        protected void printlnDesire() {
            System.out.println(c.WANT_STRING + c.CHEAP_CAR);
        }
    }
