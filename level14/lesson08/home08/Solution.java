...
/* Исправление ошибок
1. Подумать, как связаны интерфейсы Swimable(способен плавать) и Walkable(способен ходить) с классом anAnimaOcel(животное океана).
...
public class Solution
{
    ...
    static class Otter  implements Walkable, Swimable
    {
        ...
        public void walk() {
            System.out.println("Я могу не только плавать, но и бегать.....");
        }
    }
}
